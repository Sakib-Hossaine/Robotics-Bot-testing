...
<body>
    <div class="container">
        <h1>🤖 Robot Control</h1>
        <div class="subtitle">ESP32 WiFi Robot</div>
        ...
        function updateSensors() {
            fetch('/sensors')
                ...
                .then(data => {
                    ...
                    const irLeft = document.getElementById('irLeft');
                    const irRight = document.getElementById('irRight');
                    irLeft.style.color = data.irLeft ? '#dc3545' : '#28a745';
                    irRight.style.color = data.irRight ? '#dc3545' : '#28a745';
